...
CalibrationOverlay::CalibrationOverlay(QWidget *parent) : QWidget(parent) {
  ...
  m_panel->setStyleSheet("QWidget { "
                         "  background: qlineargradient(x1:0, y1:0, x2:0, "
                         "y2:1, stop:0 #1A1A1F, stop:1 #111115); "
                         "  border-radius: 10px; "
  ...
  m_titleLabel->setStyleSheet(
      ...
      "color: #00BCD4; background: transparent; border: none; letter-spacing: "
      "1px;");
  ...
  closeBtn->setStyleSheet(
      "QPushButton { "
      "  background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #2A2A2A, "
      "stop:1 #111111); "
      "  border: 1px solid #000; border-top: 1px solid #444; border-radius: "
      "16px; "
      "  font-size: 14px; font-weight: bold; color: #888; "
      "} "
      "QPushButton:hover { color: #FF5252; background: #222; } "
      "QPushButton:pressed { background: #000; border-top: 1px solid #000; "
      "border-bottom: 1px solid #333; }");
  closeBtn->setCursor(Qt::PointingHandCursor);
  connect(closeBtn, &QPushButton::clicked, this,
          &CalibrationOverlay::closeOverlay);
...
void CalibrationOverlay::buildTpsPanel() {
  ...
  m_tpsPanel->setStyleSheet(
      QString("QWidget { background-color: %1; }").arg(CLR_BG_PANEL));
  ...
  leftCol->setStyleSheet(
      QString("background: transparent; color: %1;").arg(CLR_VALUE));
  ...
  const QString inputCss =
      QString(
          "QLineEdit { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, "
          "stop:0 #0A0A0A, stop:1 #141414); "
          "color: %2; border: 1px solid #000; border-bottom: 1px solid "
          "#2A2A30; border-right: 1px solid #1A1A20; "
          "border-radius: 6px; padding: 8px 38px 8px 12px; font-family: %4; "
          "font-size: 15px; font-weight: bold; selection-background-color: %5; "
          "}"
          "QLineEdit:focus { border: 1px solid %5; }")
          .arg(CLR_INSET, CLR_VALUE, CLR_BORDER, FONT_MONO, CLR_CYAN);
  const QString getBtnCss =
      QString(
          "QPushButton { "
          "  background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 "
          "#33333A, stop:1 #1A1A1F); "
          "  color: %1; border: 1px solid #000; border-top: 1px solid #555560; "
          "  border-radius: 6px; padding: 8px 14px; font-family: %2; "
          "font-size: 12px; font-weight: 700; "
          "}"
          "QPushButton:hover { background: qlineargradient(x1:0, y1:0, x2:0, "
          "y2:1, stop:0 #44444A, stop:1 #222225); }"
          "QPushButton:pressed { background: #0A0A0A; border-top: 1px solid "
          "#000; border-bottom: 1px solid #333; }")
  ...
  left->addWidget(buildInputRow("CLOSED THROTTLE ADC COUNT", m_tpsClosedEdit,
                                getClosedBtn));
  left->addWidget(
      buildInputRow("FULL THROTTLE ADC COUNT", m_tpsFullEdit, getFullBtn));
  ...
  QWidget *adcPair = new QWidget();
  adcPair->setStyleSheet("background:transparent;");
  QHBoxLayout *aph = new QHBoxLayout(adcPair);
  aph->setContentsMargins(0, 0, 0, 0);
  aph->setSpacing(8);
  ...
  m_tpsLiveAdcLbl->setStyleSheet(
      QString("color:%1; font-family:%2; font-size:16px; "
              "font-weight:600; background:transparent;")
          .arg(CLR_VALUE, FONT_MONO));
  aph->addWidget(adcLab);
  aph->addWidget(m_tpsLiveAdcLbl);

  QWidget *tpsPair = new QWidget();
  tpsPair->setStyleSheet("background:transparent;");
  ...
  m_tpsLivePctLbl->setStyleSheet(
      QString("color:%1; font-family:%2; font-size:16px; "
              "font-weight:600; background:transparent;")
          .arg(CLR_CYAN, FONT_MONO));
  tph->addWidget(tpsLab);
  tph->addWidget(m_tpsLivePctLbl);
  ...
  m_tpsLiveBar->setStyleSheet(
      QString(
          "QProgressBar { border: 1px solid %1; background: %2; border-radius: "
          "6px; }"
  ...
  QLabel *s0 = new QLabel("0%");
  s0->setStyleSheet(scaleStyle);
  QLabel *s50 = new QLabel("50%");
  s50->setStyleSheet(scaleStyle);
  QLabel *s100 = new QLabel("100%");
  s100->setStyleSheet(scaleStyle);
  ...
  auto makeStatCell = [&](const QString &label, const QString &initialVal,
                          const QString &valColor, bool divider,
                          QLabel **outVal) {
    QWidget *cell = new QWidget();
    cell->setStyleSheet(
        QString("background: transparent; %1")
  ...
  // ── RIGHT COLUMN: 3D throttle view ───────────────────────────────
  QWidget *rightCol = new QWidget();
  rightCol->setStyleSheet(
      "background: qradialgradient(cx:0.5,cy:0.4,radius:0.9, stop:0 "
      "#15191F,stop:1 #0B0D11);"
      "border: 1px solid #000; border-top: 1px solid #222; border-left: 1px "
      "solid #222;"
      "border-radius: 12px;");
  ...
  auto makeHud = [&](const QString &label, const QString &val,
    ...
    box->setStyleSheet(
        QString("background: rgba(13,15,18,180); "
  ...
  cancelBtn->setStyleSheet(
      "QPushButton { "
      "  background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #33333A, "
      "stop:1 #1A1A1F); "
      "  color: #FFF; border: 1px solid #000; border-top: 1px solid #555560; "
      "  border-radius: 6px; padding: 9px 20px; font-family: 'Inter', "
      "sans-serif; font-size: 13px; font-weight: 700; "
      "} "
      "QPushButton:hover { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, "
      "stop:0 #44444A, stop:1 #222225); } "
      "QPushButton:pressed { background: #0A0A0A; border-top: 1px solid #000; "
      "border-bottom: 1px solid #333; }");
  QPushButton *acceptBtn = new QPushButton("Accept");
  acceptBtn->setCursor(Qt::PointingHandCursor);
  acceptBtn->setStyleSheet(
      "QPushButton { "
      "  background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #00E676, "
      "stop:0.4 #00C853, stop:1 #00A300); "
      "  color: #FFFFFF; border: 1px solid #003300; border-top: 1px solid "
      "#69F0AE; border-left: 1px solid #00E676; "
      "  border-radius: 6px; padding: 9px 20px; font-family: 'Inter', "
      "sans-serif; font-size: 13px; font-weight: 900; "
      "} "
      "QPushButton:hover { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, "
      "stop:0 #69F0AE, stop:0.4 #00E676, stop:1 #00C853); } "
      "QPushButton:pressed { background: qlineargradient(x1:0, y1:0, x2:0, "
      "y2:1, stop:0 #004D00, stop:1 #00C853); border-top: 1px solid #003300; "
      "border-bottom: 1px solid #00E676; }");
  connect(cancelBtn, &QPushButton::clicked, this,
          &CalibrationOverlay::closeOverlay);
  connect(acceptBtn, &QPushButton::clicked, this,
          &CalibrationOverlay::onTpsAccept);
...
void CalibrationOverlay::buildMapPanel() {
  ...
  const QString labelCss =
      QString(
          ...
          .arg(CLR_LABEL, FONT_SANS);
  const QString fieldCss =
      QString("QComboBox, QLineEdit { background: qlineargradient(x1:0, y1:0, "
              "x2:0, y2:1, stop:0 #0A0A0A, stop:1 #141414); "
              "color: %2; border: 1px solid #000; border-bottom: 1px solid "
              "#2A2A30; border-right: 1px solid #1A1A20; "
              "border-radius: 6px; padding: 8px 12px; font-family: %4; "
  ...
  m_mapSensorCombo->addItems(
      {"GM 1-BAR", "GM 2-BAR", "GM 3-BAR", "MPX4115", "MPX4250", "Custom"});
  ...
  m_map0Edit->setStyleSheet(fieldCss);
  left->addWidget(makeRow("kPa AT 0.0 VOLTS", m_map0Edit));

  m_map5Edit = new QLineEdit();
  m_map5Edit->setStyleSheet(fieldCss);
  left->addWidget(makeRow("kPa AT 5.0 VOLTS", m_map5Edit));

  connect(m_mapSensorCombo, &QComboBox::currentTextChanged, this,
          [this](const QString &name) {
            if (name == "GM 1-BAR") {
              m_map0Edit->setText("10");
              m_map5Edit->setText("105");
            } else if (name == "GM 2-BAR") {
              m_map0Edit->setText("8");
              m_map5Edit->setText("208");
            } else if (name == "GM 3-BAR") {
              m_map0Edit->setText("4");
              m_map5Edit->setText("304");
            } else if (name == "MPX4115") {
              m_map0Edit->setText("10");
              m_map5Edit->setText("115");
            } else if (name == "MPX4250") {
              m_map0Edit->setText("20");
              m_map5Edit->setText("250");
            }
            if (m_mapVisual)
              m_mapVisual->setKpa(0.0);
          });

  // Live kPa readout + bar
  QWidget *liveWrap = new QWidget();
  liveWrap->setStyleSheet("background:transparent;");
  QVBoxLayout *lv = new QVBoxLayout(liveWrap);
  lv->setContentsMargins(0, 0, 0, 0);
  lv->setSpacing(6);
  m_mapLiveKpaLbl = new QLabel("MAP: --- kPa");
  m_mapLiveKpaLbl->setStyleSheet(
      QString("color: %1; font-family: %2; font-size: 15px; font-weight: 600; "
              "background:transparent;")
          .arg(CLR_CYAN, FONT_MONO));
  ...
  m_mapLiveBar->setFixedHeight(10);
  m_mapLiveBar->setStyleSheet(
      QString(
          "QProgressBar { border:1px solid %1; background:%2; "
          "border-radius:5px; }"
          "QProgressBar::chunk { background: "
          "qlineargradient(x1:0,y1:0,x2:1,y2:0,"
  ...
  burnBtn->setStyleSheet(
      "QPushButton { "
      "  background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #FFA000, "
      "stop:0.4 #FF8F00, stop:1 #FF6F00); "
      "  color: #FFFFFF; border: 1px solid #4E342E; border-top: 1px solid "
      "#FFD54F; border-left: 1px solid #FFCA28; "
      "  border-radius: 6px; padding: 9px 20px; font-family: 'Inter', "
      "sans-serif; font-size: 13px; font-weight: 900; "
      "} "
      "QPushButton:hover { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, "
      "stop:0 #FFCA28, stop:0.4 #FFB300, stop:1 #FFA000); } "
      "QPushButton:pressed { background: qlineargradient(x1:0, y1:0, x2:0, "
      "y2:1, stop:0 #3E2723, stop:1 #FF6F00); border-top: 1px solid #3E2723; "
      "border-bottom: 1px solid #FFA000; }");
  QPushButton *closeBtn2 = new QPushButton("Close");
  closeBtn2->setCursor(Qt::PointingHandCursor);
  closeBtn2->setStyleSheet(
      "QPushButton { "
      "  background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #33333A, "
      "stop:1 #1A1A1F); "
      "  color: #FFF; border: 1px solid #000; border-top: 1px solid #555560; "
  ...
  vizTitle->setStyleSheet(
      QString("color:%1; font-family:%2; font-size:10px; letter-spacing:1.5px; "
              "background:transparent;")
          .arg(CLR_LABEL, FONT_MONO));
  ...
  footer->setStyleSheet(
      QString("background:#13161A; border-top:1px solid %1;").arg(CLR_BORDER2));
  footer->setFixedHeight(48);
  QHBoxLayout *fh = new QHBoxLayout(footer);
  fh->setContentsMargins(28, 0, 28, 0);
  QLabel *stat = new QLabel("SENSOR  ·  CALIBRATION");
  stat->setStyleSheet(QString("color:#3A4252; font-family:%1; font-size:10px; "
                              "letter-spacing:1.4px; background:transparent;")
                          .arg(FONT_MONO));
  fh->addWidget(stat);
  fh->addStretch();
...
void CalibrationOverlay::buildTempPanel() {
  ...
  const QString labelCss =
      QString("color:%1; font-family:%2; font-size:11px; letter-spacing:1.4px; "
              "background:transparent; border:none;")
          .arg(CLR_LABEL, FONT_SANS);
  const QString fieldCss =
      QString("QComboBox, QLineEdit { background: qlineargradient(x1:0, y1:0, "
              ...
              "color:%2; border:1px solid #000; border-bottom:1px solid "
              "#2A2A30; border-right:1px solid #1A1A20; "
              "border-radius:6px; padding:7px 12px; font-family:%4; "
  ...
  m_tempBiasEdit->setStyleSheet(fieldCss);
  ...
  calHeader->setStyleSheet(
      QString("color:%1; font-family:%2; font-size:11px; font-weight:700; "
              "letter-spacing:1.4px; background:transparent;")
          .arg(CLR_NEON, FONT_SANS));
  left->addWidget(calHeader);

  m_tempR1Edit = new QLineEdit();
  m_tempR1Edit->setStyleSheet(fieldCss);
  m_tempT1Edit = new QLineEdit();
  m_tempT1Edit->setStyleSheet(fieldCss);
  m_tempR2Edit = new QLineEdit();
  m_tempR2Edit->setStyleSheet(fieldCss);
  m_tempT2Edit = new QLineEdit();
  m_tempT2Edit->setStyleSheet(fieldCss);
  m_tempR3Edit = new QLineEdit();
  m_tempR3Edit->setStyleSheet(fieldCss);
  m_tempT3Edit = new QLineEdit();
  m_tempT3Edit->setStyleSheet(fieldCss);

  auto makePair = [&](const QString &rl, QLineEdit *re, const QString &tl,
                      QLineEdit *te) {
    QWidget *w = new QWidget();
    w->setStyleSheet("background:transparent;");
  ...
  left->addWidget(
      makePair("RESISTANCE 1 (Ω)", m_tempR1Edit, "TEMP 1 (°C)", m_tempT1Edit));
  left->addWidget(
      makePair("RESISTANCE 2 (Ω)", m_tempR2Edit, "TEMP 2 (°C)", m_tempT2Edit));
  left->addWidget(
      makePair("RESISTANCE 3 (Ω)", m_tempR3Edit, "TEMP 3 (°C)", m_tempT3Edit));

  connect(m_tempSensorCombo, &QComboBox::currentTextChanged, this,
          [this](const QString &name) {
            auto fill = [this](const QString &bias, const QString &r1,
                               const QString &t1, const QString &r2,
                               const QString &t2, const QString &r3,
                               const QString &t3) {
              m_tempBiasEdit->setText(bias);
              m_tempR1Edit->setText(r1);
              m_tempT1Edit->setText(t1);
              m_tempR2Edit->setText(r2);
              m_tempT2Edit->setText(t2);
              m_tempR3Edit->setText(r3);
              m_tempT3Edit->setText(t3);
            };
            if (name == "GM")
              fill("2490", "9420", "0", "2490", "25", "667", "80");
            else if (name == "RX-7 S4/S5")
              fill("2490", "20000", "0", "5200", "25", "1300", "70");
            else if (name == "Ford")
              fill("2490", "95540", "0", "37300", "25", "5570", "80");
            else if (name == "Bosch")
              fill("2490", "5896", "0", "2500", "20", "323", "100");
          });
  ...
  m_tempLiveBar->setFixedHeight(10);
  m_tempLiveBar->setStyleSheet(
      QString("QProgressBar { border:1px solid %1; background:%2; "
              "border-radius:5px; }"
              "QProgressBar::chunk { background: "
              "qlineargradient(x1:0,y1:0,x2:1,y2:0,"
              "stop:0 #2563EB,stop:0.45 #22C55E,stop:0.75 %3,stop:1 #EF4444); "
              "border-radius:5px; }")
  ...
  connect(closeBtn2, &QPushButton::clicked, this,
          &CalibrationOverlay::closeOverlay);
  connect(burnBtn, &QPushButton::clicked, this,
          &CalibrationOverlay::onTempBurn);
  QHBoxLayout *btnRow = new QHBoxLayout();
  btnRow->addStretch();
  btnRow->addWidget(burnBtn);
  btnRow->addSpacing(8);
...
void CalibrationOverlay::buildDutyPanel() {
  ...
  QLabel *infoDesc = new QLabel(
      ...
      "near maximum capacity and may go static (staying open 100% of the "
      "time).\n\n"
      "Adjust required fuel and injector dead-time in Fuel Settings.");
  infoDesc->setWordWrap(true);
  infoDesc->setStyleSheet(
      QString("color:%1; font-family:%2; font-size:13px; line-height: 1.5; "
              "background:transparent;")
          .arg(CLR_LABEL, FONT_SANS));
  ...
  m_dutyLiveLbl->setStyleSheet(
      QString("color:%1; font-family:%2; font-size:15px; font-weight:600; "
              "background:transparent;")
          .arg(CLR_CYAN, FONT_MONO));
  lv->addWidget(m_dutyLiveLbl);
  m_dutyLiveBar = new QProgressBar();
  m_dutyLiveBar->setRange(0, 100);
  m_dutyLiveBar->setValue(0);
  m_dutyLiveBar->setTextVisible(false);
  m_dutyLiveBar->setFixedHeight(10);
  m_dutyLiveBar->setStyleSheet(
      QString("QProgressBar { border:1px solid %1; background:%2; "
              "border-radius:5px; }"
              "QProgressBar::chunk { background: "
              "qlineargradient(x1:0,y1:0,x2:1,y2:0,"
              "stop:0 #3B82F6,stop:0.6 #0EA5E9,stop:0.85 #F59E0B,stop:1 "
              "#EF4444); border-radius:5px; }")
...
void CalibrationOverlay::loadTpsFromSettings() {
  ...
  m_tpsLiveBar->setValue(0);
  if (m_tpsAngleLbl)
    m_tpsAngleLbl->setText("0.0°");
  if (m_tpsHudOpenLbl)
    m_tpsHudOpenLbl->setText("0.0%");
  if (m_tpsHudAngleLbl)
    m_tpsHudAngleLbl->setText("0.0°");
  if (m_tpsStatAdc)
    m_tpsStatAdc->setText("0");
  if (m_tpsStatRange)
    m_tpsStatRange->setText(QString::number(qMax(0, full - closed)));
  if (m_tpsStatDead)
    m_tpsStatDead->setText(QString::number(closed));
  if (m_throttleBody)
    m_throttleBody->setTPS(0.0);
}
...
void CalibrationOverlay::loadTempFromSettings() {
  ...
  m_tempR1Edit->setText("9420");
  m_tempT1Edit->setText("0");
  m_tempR2Edit->setText("2490");
  m_tempT2Edit->setText("25");
  m_tempR3Edit->setText("667");
  m_tempT3Edit->setText("80");
  m_tempLiveBar->setValue(-40);
...
void CalibrationOverlay::updateLiveData(const RealTimeData &data) {
  ...
  if (m_stack->currentWidget() == m_tpsPanel) {
    ...
    if (m_throttleBody)
      m_throttleBody->setTPS(tpsPct);

    // HUD readouts (next to / under the throttle body)
    if (m_tpsAngleLbl)
      m_tpsAngleLbl->setText(QString("%1°").arg(angle, 0, 'f', 1));
    if (m_tpsHudOpenLbl)
      m_tpsHudOpenLbl->setText(QString("%1%").arg(tpsPct, 0, 'f', 1));
    if (m_tpsHudAngleLbl)
      m_tpsHudAngleLbl->setText(QString("%1°").arg(angle, 0, 'f', 1));

    // 4-cell stat strip (ADC / RANGE / DEADBAND / STATUS)
    const int closed = m_tpsClosedEdit->text().toInt();
    const int full = m_tpsFullEdit->text().toInt();
    if (m_tpsStatAdc)
      m_tpsStatAdc->setText(QString::number(m_lastTpsADC));
    if (m_tpsStatRange)
      m_tpsStatRange->setText(QString::number(qMax(0, full - closed)));
    if (m_tpsStatDead)
      m_tpsStatDead->setText(QString::number(closed));
...
void CalibrationOverlay::awaitBurnAndShowResult(const QString &opName,
  ...
  auto finish = [this, state, watchdog, opName, closeOverlayOnSuccess](
    ...
    if (state->done)
      return; // First handler wins; ignore the others.
    state->done = true;
    ...
    if (success) {
      QMessageBox::information(
          this, "Success",
          QString("%1 Calibration successfully written to controller.")
              .arg(opName));
      ...
      QMessageBox::critical(
          ...
          QString("%1 calibration write failed: %2")
              .arg(opName, errorReason.isEmpty()
  ...
  state->okConn =
      connect(m_settingsManager, &ECUSettingsManager::burnAllComplete, this,
              [finish]() { finish(true, QString()); });

  state->failConn =
      connect(m_settingsManager, &ECUSettingsManager::burnAllFailed, this,
...
void CalibrationOverlay::onTpsAccept() {
  ...
  if (!ok1 || !ok2 || closedCount < 0 || fullCount < 0 || closedCount > 1023 ||
      fullCount > 1023) {
    QMessageBox::warning(
        this, "Validation Error",
        "TPS values must be valid integers between 0 and 1023.");
    return;
  }
  if (closedCount == fullCount) {
    QMessageBox::warning(
        this, "Validation Error",
        "Closed and Full throttle values cannot be identical.");
    return;
  }
  if (!m_settingsManager->hasSetting("tpsMin") ||
      !m_settingsManager->hasSetting("tpsMax")) {
    QMessageBox::critical(this, "ECU Error",
                          "Could not find 'tpsMin' or 'tpsMax' in the loaded "
                          "ECU definition. Calibration aborted.");
    return;
  }
  ...
  if (!m_serialManager || (!m_serialManager->isSimulation() &&
...
void CalibrationOverlay::onMapBurn() {
  ...
  if (!ok1 || !ok2 || map0 < 0 || map5 < 0) {
    QMessageBox::warning(
        this, "Validation Error",
        "MAP calibration values must be valid positive integers.");
    return;
  }
  if (map0 == map5) {
    QMessageBox::warning(this, "Validation Error",
                         "0V and 5V MAP values cannot be identical.");
    return;
  }
  if (!m_settingsManager->hasSetting("mapMin") ||
      !m_settingsManager->hasSetting("mapMax")) {
    QMessageBox::critical(this, "ECU Error",
                          "Could not find 'mapMin' or 'mapMax' in the loaded "
                          "ECU definition. Calibration aborted.");
    return;
  }
  // Don't claim success if the burn is going to be silently dropped because
...
void CalibrationOverlay::onTempBurn() {
  if (!m_serialManager) {
    QMessageBox::warning(this, "Not Connected",
                         "Cannot upload calibration - no serial connection.");
    return;
  }
  ...
  if (biasR <= 0 || r1 <= 0 || r2 <= 0 || r3 <= 0) {
    QMessageBox::warning(
        this, "Invalid Input",
        "Resistance values must be strictly greater than zero.");
    return;
  }
  if (std::abs(r1 - r2) < 0.001 || std::abs(r2 - r3) < 0.001 ||
      std::abs(r1 - r3) < 0.001) {
    QMessageBox::critical(
        this, "Calculation Error",
        "Resistance values for the 3 points must be strictly distinct.");
    return;
  }
  if (std::abs(t1 - t2) < 0.001 || std::abs(t2 - t3) < 0.001 ||
      std::abs(t1 - t3) < 0.001) {
    QMessageBox::critical(
        this, "Calculation Error",
        "Temperature values for the 3 points must be strictly distinct.");
    return;
  }
  ...
  QMessageBox::information(
      this, "Calibration Sent",
      QString("%1 calibration table (%2 bytes) sent to ECU via 't' command.")
          .arg(tableIdx == 0 ? "CLT" : "IAT")
          .arg(table.size()));
  closeOverlay();
}

QByteArray CalibrationOverlay::generateThermistorTable(double biasResistor,
                                                       double r1, double t1,
                                                       double r2, double t2,
                                                       double r3, double t3) {
...
// DataCard
DataCard::DataCard(const QString &label, const QColor &dotColor,
                   QWidget *parent)
    : QFrame(parent) {
  setFixedSize(106, 56);
  ...
  lbl->setStyleSheet(
      QString("font-family: 'JetBrains Mono'; font-size: 10px; color: %1;")
          .arg(TunerProColors::TEXT_SECONDARY));
  lbl->move(6, 4);
  m_valLabel = new QLabel("0.0", this);
  m_valLabel->setStyleSheet(QString("font-family: 'JetBrains Mono'; font-size: "
                                    "20px; font-weight: bold; color: %1;")
...
void DataCard::setValue(const QString &value) { m_valLabel->setText(value); }
...
StatusLine::StatusLine(const QString &label, QWidget *parent)
  ...
  m_label->setStyleSheet(
      QString(
          "font-family: 'Inter'; font-size: 11px; font-weight: 500; color: %1;")
          .arg(TunerProColors::TEXT_SECONDARY));
...
void StatusLine::setStatus(bool active, const QColor &activeColor) {
  if (active) {
    ...
    m_label->setStyleSheet(QString("font-family: 'Inter'; font-size: 11px; "
...
void StatusLine::setPercentage(int percent, const QColor &color) {
  ...
  m_indicator->setStyleSheet(
      QString("background-color: %1; border-radius: 2px;").arg(color.name()));
}
...
void DashboardWidget::setSettingsManager(ECUSettingsManager *mgr) {
  ...
  if (mgr) {
    connect(mgr, &ECUSettingsManager::settingChanged, this,
            &DashboardWidget::onSettingChanged, Qt::UniqueConnection);
  }
  if (m_calOverlay)
    m_calOverlay->setSettingsManager(mgr);
}

void DashboardWidget::setSerialManager(SerialManager *sm) {
  if (m_calOverlay)
    m_calOverlay->setSerialManager(sm);
}

void DashboardWidget::onSettingChanged(const QString &name,
...
void DashboardWidget::setupUi() {
  ...
  fuelPanel->setStyleSheet(QString("QFrame { background-color: %1; border: 1px "
  ...
  fTitle->setStyleSheet(
      QString("font-family: 'Barlow Condensed'; font-size: 13px; font-weight: "
              "bold; color: %1; margin-bottom: 4px;")
  ...
  auto setupGauge = [this](TunerGauge *&gauge, const QString &label,
                           double minV, double maxV, double danger) {
  ...
  connect(m_mapGauge, &TunerGauge::clicked, this,
          [=]() { handleCalibClick("MAP Sensor Calibration"); });
  connect(m_tpsGauge, &TunerGauge::clicked, this,
          [=]() { handleCalibClick("TPS Calibration"); });
  connect(m_cltGauge, &TunerGauge::clicked, this,
          [=]() { handleCalibClick("Coolant Temp Calibration"); });
  connect(m_iatGauge, &TunerGauge::clicked, this,
          [=]() { handleCalibClick("Intake Air Temp Calibration"); });
  connect(m_dutyGauge, &TunerGauge::clicked, this,
          [=]() { handleCalibClick("Injector Duty %"); });
  ...
  graphsContainer->setSizePolicy(QSizePolicy::Expanding,
...
void DashboardWidget::resizeEvent(QResizeEvent *event) {
  if (m_calOverlay)
    m_calOverlay->resize(event->size());
...
void DashboardWidget::updateData(const RealTimeData &data) {
  if (m_calOverlay)
    m_calOverlay->updateLiveData(data);
  ...
  m_stHardLimit->setStatus(data.isHardLimitActive(),
                           QColor(TunerProColors::DANGER));
  m_stSoftLimit->setStatus(data.isSoftLimitActive(),
                           QColor(TunerProColors::WARN));
